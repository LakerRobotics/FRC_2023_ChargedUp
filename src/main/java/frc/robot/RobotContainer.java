...
//true));
    ...
    SmartDashboard.putData("IntakeConeHoldStart", new IntakeConeHoldStart( m_intake ));
    SmartDashboard.putData("ArmControlStowedPosition", new ArmControlStowedPosition( m_arm));
    SmartDashboard.putData("ArmControlHighPosition", new ArmControlHighPosition( m_arm));
    SmartDashboard.putData("ArmControlMidPosition", new ArmControlMidPosition( m_arm));
...
final JoystickButton driveTrainLFieldOrientedButton = new JoystickButton(driverController, PS4Controller.Button.kL1.value);        
                     driveTrainLFieldOrientedButton.whileTrue(new DriveTrainFieldOrientated (m_driveTrain));
...
final JoystickButton armMidButton = new JoystickButton(operatorController, PS4Controller.Button.kSquare.value);
                     armMidButton.whileTrue(new ArmControlMidPosition( m_arm ));
final JoystickButton armStowButton = new JoystickButton(operatorController, PS4Controller.Button.kCross.value);
