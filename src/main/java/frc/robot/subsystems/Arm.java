...
public class Arm extends SubsystemBase {
    ...
    private final double kMaxOutput =  Constants.ArmConstants.ARM_OUTPUT_POWER_AUTON/2;
    private final double kMinOutput =  -Constants.ArmConstants.ARM_OUTPUT_POWER_AUTON/2;
