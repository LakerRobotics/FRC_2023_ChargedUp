...
public class ArmControlMidPosition extends CommandBase {
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
        ...
        private static final double m_curbShootRPM = 0.55*5000;
    ...
    @Override
    public void execute() {
        if(java.lang.Math.abs((m_arm.getSpeed()-m_curbShootRPM)/m_curbShootRPM) < 0.1){
            // Rumble power is 100% less 10% for every 1% off of the target speed, so will be at max rumbel when at speed
            double rumblePower = 1-10*java.lang.Math.abs((m_arm.getSpeed()-m_curbShootRPM)/m_curbShootRPM);
        ...
        SmartDashboard.putNumber("Shooter Low Speed", m_arm.getSpeed());
    }
